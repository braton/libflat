...
FUNCTION_DEFINE_FLATTEN_STRUCT2_ITER(B,
);
...
FUNCTION_DEFINE_FLATTEN_STRUCT2_ITER(A,
	STRUCT_ALIGN(120);
	AGGREGATE_FLATTEN_STRUCT2_ITER(B,pB0);
	AGGREGATE_FLATTEN_STRUCT2_ITER(B,pB1);
	AGGREGATE_FLATTEN_STRUCT2_ITER(B,pB2);
	AGGREGATE_FLATTEN_STRUCT2_ITER(B,pB3);
